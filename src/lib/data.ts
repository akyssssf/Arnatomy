...
import {
  BodyPartSchema, LayerSchema, OrganSchema, PartContentSchema, SistemOrganSchema, UserSchema,
} from "./schemas";
...
export const sistem_organ = z.array(SistemOrganSchema).parse([
  { id_sistem: 1, nama: 'Sistem Peredaran Darah', id_organ: 1,    status: 'tersedia', organ: 'Jantung',   gambar: '/img/jantung.webp' },
  { id_sistem: 2, nama: 'Sistem Pernapasan',      id_organ: 2,    status: 'tersedia', organ: 'Paru-paru', gambar: '/img/paru.webp' },
  { id_sistem: 3, nama: 'Sistem Saraf',           id_organ: null, status: 'segera',   organ: 'Otak',      gambar: '/img/otak.webp' },
  { id_sistem: 4, nama: 'Sistem Pencernaan',      id_organ: null, status: 'segera',   organ: 'Usus',      gambar: '/img/usus.webp' },
  { id_sistem: 5, nama: 'Sistem Ekskresi',        id_organ: null, status: 'segera',   organ: 'Ginjal',    gambar: '/img/ginjal.webp' },
  { id_sistem: 6, nama: 'Sistem Endokrin',        id_organ: null, status: 'segera',   organ: 'Pankreas',  gambar: '/img/pankreas.webp' },
  { id_sistem: 7, nama: 'Sistem Indra',           id_organ: null, status: 'segera',   organ: 'Mata',      gambar: '/img/mata.webp' },
  { id_sistem: 8, nama: 'Sistem Integumen',       id_organ: null, status: 'segera',   organ: 'Kulit',     gambar: '/img/kulit.webp' }
]);
...
export const PengetahuanSchema = z.object({
  fungsi: z.string(), letak: z.string(), gangguan: z.string(), ringkas: z.string(),
});
